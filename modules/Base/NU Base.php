...
class Base extends BisDatabase
{
    private $error='';
    ...
    public function getField($name)
    {
        ...
        switch ($name)
        {
            ...
            case 'DatePub':
            case 'DateVali':
                // Affiche la date AAAA-MM-JJ sous la forme JJ/MM/AAAA
    ...
    public function setField($name, &$value)
    {
        switch ($name)
        {
            case 'FinSaisie':
            case 'Valide':
                if (Utils::get($_POST[$name], false)) $value=true; else $value=false;
                break;
...
//            $value));
    ...
    // seule et unique action de ce module, affiche la liste des fichiers à importer
    public function actionIndex()
    {
        ...
        // Initialise $file avec la liste complète des fichiers, pour affichage
        ...
        if (isset($_REQUEST['delete']))
            $this->delete(Utils::get($_REQUEST['delete']));
        ...
        Template::run('Import.yaml','Template::varCallback');
        ...
        if (isset($_REQUEST['import']))
        {
            ...
            TaskManager::addTask('importfiles', 0, null, 'Import des fichiers de notices');
        }
    }
    ...
    public function actionImportFiles()
    {
        ...
        {
            TaskManager::progress('Import du fichier' . $file['name'] . ' en cours...');
            ...
            TaskManager::progress('Import du fichier' . $file['name'] . 'terminé');
